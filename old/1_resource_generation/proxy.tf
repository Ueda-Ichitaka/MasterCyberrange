resource "openstack_networking_port_v2" "attack_range-network-access-proxy-port" {
...
resource "openstack_networking_floatingip_associate_v2" "floatingip-access-proxy" {
  ...
  port_id = openstack_networking_port_v2.attack_range-network-access-proxy-port.id
}
...
resource "openstack_compute_instance_v2" "access-proxy" {
  ...
  network {
    access_network = true
    port = openstack_networking_port_v2.attack_range-network-access-proxy-port.id
  }
